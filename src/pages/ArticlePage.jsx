...
const ArticlePage = () => {
  ...
  // Ref to hold all comment DOM elements for scrolling
  ...
  // New function to scroll to a specific comment in the main section
  const handleShowRepliesInMain = useCallback((commentId) => { //
    const element = commentRefs.current[commentId]; //
    if (element) { //
      element.scrollIntoView({ behavior: 'smooth', block: 'center' }); //
      // Add a temporary highlight to the scrolled comment
      ...
      <div className={styles.pageContainer}>
        ...
        <div className={styles.layoutGrid}>
          <main className={styles.mainContent}>
            ...
            {/* Article Comments Section (bottom) */}
            <section className={styles.commentsSection}>
              ...
              <div className={styles.commentsListContainer}>
                {isLoadingComments ? (
                  ...
                  <>
                    {/* Render comments list only if there are comments */}
                    {comments.length > 0 ? (
                      <ArticleCommentsList 
                        ...
                        isSidebarView={false}
                        setCommentRefs={commentRefs} // Pass the ref object
                      />
                    ) : (
            ...
            <div className={styles.sidebarContent}>
              {article.profiles && (
                <div className={styles.authorInfo}>
                  <img
                    src={article.profiles.avatar_url || `https://ui-avatars.com/api/?name=${encodeURIComponent(article.profiles.username || 'A')}`.trim()}
              ...
              <div className={styles.sidebarCommentsSection}>
                ...
                {/* Sidebar comment submission form */}
                {authUser ? (
                  <ArticleCommentForm 
                    onSubmit={handleSubmitComment} 
                    isSubmitting={isSubmittingComment} 
                    ...
                    <>
                      ...
                      {comments.length > 0 ? (
                        <ArticleCommentsList 
                          ...
                          allComments={comments}
                          isSidebarView={true}
                          onShowRepliesClick={handleShowRepliesInMain} // Pass scroll handler
                          // No explicit maxSidebarDepth prop needed here anymore, handled internally by CommentItem's constants
                        />
                      ) : (
